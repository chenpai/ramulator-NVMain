...
void LHDecoder::SetIgnoreBits( uint64_t numIgnore )
{
    ignoreBits = numIgnore;
}

void LHDecoder::SetCachelineSize( uint64_t lineSize )
{
    cachelineSize = lineSize;
}

void LHDecoder::Translate( uint64_t address, uint64_t *row, uint64_t *col, 
...
uint64_t LHDecoder::ReverseTranslate( const uint64_t& row, 
                                       const uint64_t& /*col*/, 
                                       const uint64_t& /*bank*/,
				       const uint64_t& /*rank*/, 
